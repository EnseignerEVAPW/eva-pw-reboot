...
let AuthService = class AuthService {
    constructor(usersService, jwtService, codeforcesService) {
        this.usersService = usersService;
        this.jwtService = jwtService;
        this.codeforcesService = codeforcesService;
    }
    async register({ password, username, passwordConfirmation }) {
        ...
        if (!checkCE) {
            throw new common_1.BadRequestException("Authentication name is not P2P-Auth");
        }
...
exports.AuthService = AuthService = __decorate([
    ...
    __metadata("design:paramtypes", [users_service_1.UsersService,
        jwt_1.JwtService,
        codeforces_service_1.CodeforcesService])
], AuthService);
