...
function Button({ children, onClick, color, fullWidth }) {
    ...
    return (
      <button style={{ backgroundColor: color, borderColor: color }} className={`${baseStyle} ${fullWidthStyle}`} onClick={onClick}>
        {children}
      </button>
    );
  }
